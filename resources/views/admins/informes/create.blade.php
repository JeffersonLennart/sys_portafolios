...
@section('content_header')
  <h1 class="text-center"><b>Agregar nuevo Informe</b></h1>
@stop
    ...
    <div class="card-body">
        <form action="{{ route('informes.store') }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="revision_id" name="revision_id" value="{{ old('revision_id') }}">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="revisor_id" name="revisor_id" value="{{ old('revisor_id') }}">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="fecha_informe" name="fecha_informe" value="{{ old('fecha_informe') }}">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="cumplimiento" name="cumplimiento" value="{{ old('cumplimiento') }}">
                </div>
