...
@section('content_header')
  <h1 class="text-center"><b>Editar Revisor</b></h1>
@stop
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('revisores.update', $revisor) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $revisor->user->name) }}">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="codigo" name="codigo" value="{{ old('codigo', $revisor->user->codigo) }}">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="telefono" name="telefono" value="{{ old('telefono', $revisor->user->telefono) }}">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select id="categoria" name="categoria" class="form-control col-12" required>
                        <?php $defaultCategoria = $revisor->user->categoria ?? old('categoria'); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select id="grado_academico" name="grado_academico" class="form-control col-12" required>
                        <?php $defaultGradoAcademico = $revisor->user->grado_academico ?? old('grado_academico'); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="email" name="email" value="{{ old('email', $revisor->user->email) }}">
                </div>
            ...
            <div class="text-center" >                
                <input type="submit" value="Editar Revisor" class="btn btn-primary">             
